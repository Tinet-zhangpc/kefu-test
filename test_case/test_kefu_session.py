...
@allure.feature('基础会话')
@allure.testcase(customerServiceUrl, '测试用例链接-客服端')
@allure.testcase(visitorUrl, '测试用例链接-访客端')
@allure.testcase(visitorUrl, '测试用例工单链接-jira地址')
class TestSession:
